...
public class PackGame : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        textAssetForGameText = Resources.Load<TextAsset>($"{LanguagePicker.BasicTextRoute()}Evaluation/Evaluation_02/Evaluation_Scene2");
        textAssetForObjects = Resources.Load<TextAsset>($"{LanguagePicker.BasicTextRoute()}Evaluation/Evaluation_Objects/Evaluation_Objects");
        stringsToShow = TextReader.TextsToShow(textAssetForGameText);
        stringsObjects = TextReader.TextsToShow(textAssetForObjects);
        stimulus = Resources.LoadAll<AudioClip>(($"{LanguagePicker.BasicAudioRoute()}Evaluation/Stimulus/Objects"));
        audioInScene = Resources.LoadAll<AudioClip>($"{LanguagePicker.BasicAudioRoute()}Evaluation/Scene_2");
